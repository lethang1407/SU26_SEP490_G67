...
public class ImportSuggestionController {
    ...
    @GetMapping
    public ApiResponse<PageResponse<GroupedSuggestionResponse>> getGroupedSuggestions(
        ...
        PageResponse<GroupedSuggestionResponse> result = importSuggestionService.getGroupedSuggestions(
                status, categoryId, keyword, page, size
        );
        return ApiResponse.<PageResponse<GroupedSuggestionResponse>>builder()
                .result(result)
