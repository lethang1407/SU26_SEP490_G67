...
public enum ErrorCode {
    ...
    STORAGE_LOCATION_LABEL_REQUIRED(1089, "Vui lòng nhập mã vị trí", HttpStatus.BAD_REQUEST),
    STORAGE_LOCATION_SLOT_INCOMPLETE(1090, "Tầng và số ô phải nhập cùng nhau hoặc để trống cả hai", HttpStatus.BAD_REQUEST),
    ...
    STORAGE_ZONE_EXISTED(1190, "Mã khu đã tồn tại", HttpStatus.CONFLICT),
    STORAGE_FLOOR_LIMIT_REACHED(1191, "Khu đã đủ số tầng tối đa (10)", HttpStatus.BAD_REQUEST),
    STORAGE_BIN_LIMIT_REACHED(1192, "Tầng đã đủ số ô tối đa (10)", HttpStatus.BAD_REQUEST),
    STORAGE_FLOOR_NOT_FOUND(1193, "Tầng không tồn tại trong khu", HttpStatus.BAD_REQUEST),
    ...
    INVENTORY_CHECK_ALL_BATCH_QTY_LOCKED(1061, "Khi chọn tất cả lô không được chỉnh tồn thực tế. Hãy chọn từng lô cụ thể.", HttpStatus.BAD_REQUEST),
    INVALID_CANCEL_BATCH_QTY(1088, "Số lượng hủy lô không hợp lệ", HttpStatus.BAD_REQUEST),
