...
public enum ErrorCode {
    ...
    PRIMARY_SALE_LOCATION_EMPTY(1052, "Ô trống không thể đặt làm ô bán. Hãy xếp hàng vào ô trước", HttpStatus.BAD_REQUEST),
    PRIMARY_SALE_LOCATION_IN_USE(1053, "Ô này đã là ô bán của sản phẩm khác", HttpStatus.CONFLICT),
