...
public interface SalesOrderRepository extends JpaRepository<SalesOrder, Integer> {
    ...
    @Query(value = """
            ...
            AND (:keyword IS NULL OR so.orderCode LIKE %:keyword%)
            """)
    Page<SalesOrder> findDebtOrdersByCustomerIdWithPriority(@Param("customerId") Integer customerId, @Param("keyword") String keyword, @Param("now") Instant now, Pageable pageable);
