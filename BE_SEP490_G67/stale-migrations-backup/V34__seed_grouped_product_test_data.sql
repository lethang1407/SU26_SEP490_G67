...
-- batch_code là NOT NULL từ V8; dùng dạng dự phòng 'BATCH-<id>' mà chính V8
-- đặt cho các lô không gắn phiếu nhập.
INSERT INTO `stock_batches` (`id`, `product_id`, `import_order_id`, `batch_code`, `quantity_in`, `cost_per_unit`, `received_date`, `expiry_date`, `batch_note`, `is_removed`, `created_at`, `updated_at`, `created_by`)
VALUES
(100, 17, 1, 'BATCH-100', 20, 37000.00, '2026-07-20', '2028-06-01', 'Dép vàng size 36', b'0', NOW(), NOW(), 1),
(101, 19, 1, 'BATCH-101', 5, 37000.00, '2026-07-20', '2028-06-01', 'Dép đỏ size 36', b'0', NOW(), NOW(), 1)
