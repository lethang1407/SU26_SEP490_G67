...
/**
 * mode = 'exchange': chọn một hóa đơn cũ để mở tab trả/đổi hàng.
 * mode = 'history':  chỉ tra cứu, nút hàng in lại hóa đơn thay vì mở tab trả.
 */
export default function SalesOrderHistoryModal({ onClose, onExchange, mode = 'exchange' }) {
    ...
    // Ô nhập giữ state riêng và chỉ đẩy xuống hook sau 300ms, để gõ một từ khóa
    ...
    // Hóa đơn đang mở ở modal chi tiết (chồng lên modal này)
    const [detailOrderId, setDetailOrderId] = useState(null);

    // Close on Escape — khi modal chi tiết đang mở thì nó tự xử lý phím này,
    // nếu không cả hai cùng đóng chỉ với một lần bấm.
    useEffect(() => {
    ...
    // In thẳng, không mở modal chi tiết: dùng khi khách quay lại xin bản in.
    ...
    // Cột trạng thái chỉ có nghĩa khi tra cứu; ở màn chọn hóa đơn để trả/đổi
    // thì mọi dòng đều là đơn đã hoàn thành nên cột này chỉ gây nhiễu.
                                                ...
                                                <td>
                                                    <div className="hist-badge-group">
                                                        ...
                                                        <DebtBadge
                                                            ...
                                                            isCheckDebtUnstable={order.isCheckDebtUnstable}
                                                        />
                                                    </div>
                                                </td>
                                            )}
