...
export default function CustomerDebtPage() {
  ...
  const [debtData, setDebtData] = useState({ content: [], totalPages: 1, page: 1, totalElements: 0 });
            ...
            <Card.Body>
              ...
              <div className="d-flex justify-content-between align-items-center mt-4">
                ...
                <Pagination className="mb-0">
                  ...
                  <Pagination.Next 
                    onClick={() => handlePageChange(filters.page + 1)}
                    disabled={filters.page === debtData.totalPages || debtData.totalPages === 0}
                  />
                </Pagination>
              </div>
            </Card.Body>
